...
final class Database
{
    ...
    public static function migrate(PDO $pdo): void
    {
        $statements = [
            ...
            'CREATE TABLE IF NOT EXISTS users (id VARCHAR(36) PRIMARY KEY, username VARCHAR(100) NOT NULL UNIQUE, display_name VARCHAR(200) NOT NULL, password_hash VARCHAR(255) NOT NULL, role VARCHAR(20) NOT NULL, enabled INTEGER NOT NULL DEFAULT 1, locale VARCHAR(10) NOT NULL DEFAULT \'en_US\', tutorial_status VARCHAR(20) NOT NULL DEFAULT \'not_started\', tutorial_step INTEGER NOT NULL DEFAULT 0, session_version INTEGER NOT NULL DEFAULT 1, created_at VARCHAR(30) NOT NULL, updated_at VARCHAR(30) NOT NULL)',
